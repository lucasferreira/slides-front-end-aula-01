...
export default function Age() {
  const borndate = new Date(1987, 2, 1);
  const [tempoDeVida, setTempoDeVida] = useState(calcMyAge(borndate));

  useEffect(() => {
    const tempoInterval = setInterval(() => {
      setTempoDeVida(calcMyAge(borndate));
    }, 1000);
  ...
  return (
    <Text fontWeight="bold" color="default" textAlign="center">
      <br />
      <br />
